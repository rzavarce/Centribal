    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_total', models.DecimalField(decimal_places=2, max_digits=22)),
                ('price_total_tax', models.DecimalField(decimal_places=2, max_digits=22)),
                ('created_date', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Created Date')),
                ('modified_date', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Modified Date')),
                ('order_detail', models.ManyToManyField(through='orders.OrderDetail', to='products.products')),
            ],
            options={
                'verbose_name': 'Order',
